...
for(i in 1:n){
  ...
  # # 83
  # Ymean1[,i] <- ifelse( zi==2, 2, -1 )*(3.4*te+2.2) + (tempg11/10)*te + (tempu1+tempg22/10) * fval1 + (tempu2+tempg21/10) * fval2 + tempu3 * fval3
  # Ymean2[,i] <- ifelse( zi==1, 1, -1 ) * 3 + ifelse( zi==3, 1, 0 ) * 4.5*te + tempg11/10 + (tempu6+tempg32/10) * fval6 + (tempu5+tempg31/10) * fval5 
  # Ymean3[,i] <- zi * (2.8*te+2) +tempu8 * fval8 + tempu9 * fval9
  ...
  ######## 80
  # Ymean1[,i] <- ifelse( zi==2, 2, -1 )*(3.4*te+0.5) + (tempg11/10)*te + (tempu1+tempg22/10) * fval1 + (tempu2+tempg21/10) * fval2 + tempu3 * fval3
  # Ymean2[,i] <- ifelse( zi==1, 1, -1 ) * 3 + ifelse( zi==3, 1, 0 ) * 4.5*te + tempg11/10 + (tempu6+tempg32/10) * fval6 + (tempu5+tempg31/10) * fval5 
  # Ymean3[,i] <- zi * (3*te+3) +tempu8 * fval8 + tempu9 * fval9
  
  # ########### 85
  # Ymean1[,i] <- ifelse( zi==2, 2, -1 )*(4*te+0.5) + (tempg11/10)*te + (tempu1+tempg22/10) * fval1 + (tempu2+tempg21/10) * fval2 + tempu3 * fval3
  # Ymean2[,i] <- ifelse( zi==1, 1, -1 ) * 3 + ifelse( zi==3, 1, 0 ) * 5*te + tempg11/10 + (tempu6+tempg32/10) * fval6 + (tempu5+tempg31/10) * fval5 
  # Ymean3[,i] <- zi * (3*te+3) +tempu8 * fval8 + tempu9 * fval9
  ...
  Ymean3[,i] <- zi * (4*te+2) +tempu8 * fval8 + tempu9 * fval9
}
