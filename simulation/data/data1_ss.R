...
for(i in 1:n){
  ...
  tempu2 <- rnorm(1,    ifelse( zi==2, 2, 0 ),  1.3)
  tempu3 <- rnorm(1,    (5-zi),  0.7)
  tempu5 <- rnorm(1,    (zi+2),  0.7) #rnorm(1,    ifelse( zi==3, 2, 0 ),  1.5) #rnorm(1,    (zi-2),  1)
  tempu6 <- rnorm(1,    (5-zi),  0.7)
  tempu8 <- rnorm(1,    ifelse( zi==3, zi-1, 0 ) + ifelse( zi==1, zi, 0 ),  1.3)
  tempu9 <- rnorm(1,    (zi-2),  0.7)
  ...
  # Ymean1[,i] <- ifelse( zi==2, 2, -1 )*(3.3*te+2) + (tempg11/10)*te + (tempu1+tempg22/10) * fval1 + (tempu2+tempg21/10) * fval2 + tempu3 * fval3
  # Ymean2[,i] <- ifelse( zi==1, 1, -1 ) * 2.6 + ifelse( zi==3, 1, 0 ) * 3.5*te + tempg11/10 + (tempu6+tempg32/10) * fval6 + (tempu5+tempg31/10) * fval5 
  # Ymean3[,i] <- zi * (2.4*te+1.8) +tempu8 * fval8 + tempu9 * fval9
  
  # Ymean1[,i] <- ifelse( zi==2, 2, -1 )*(4*te+2) + (tempg11/10)*te + (tempu1+tempg22/10) * fval1 + (tempu2+tempg21/10) * fval2 + tempu3 * fval3
  # Ymean2[,i] <- ifelse( zi==1, 1, -1 ) * 4 + ifelse( zi==3, 1, 0 ) * 2*te + tempg11/10 + (tempu6+tempg32/10) * fval6 + (tempu5+tempg31/10) * fval5 
  # Ymean3[,i] <- zi * (3*te+3) +tempu8 * fval8 + tempu9 * fval9
  
  # Ymean1[,i] <- ifelse( zi==2, 2, -1 )*(4*te+0.3) + (tempg11/10)*te + (tempu1+tempg22/10) * fval1 + (tempu2+tempg21/10) * fval2 + tempu3 * fval3
  # Ymean2[,i] <- ifelse( zi==1, 1, -1 ) * 3 + ifelse( zi==3, 1, 0 ) * 2.5*te + tempg11/10 + (tempu6+tempg32/10) * fval6 + (tempu5+tempg31/10) * fval5 
  # Ymean3[,i] <- zi * (3.5*te+4.3) +tempu8 * fval8 + tempu9 * fval9
  
  Ymean1[,i] <- ifelse( zi==2, 2, -1 )*(4*te+1) + (tempg11/10)*te + (tempu1+tempg22/10) * fval1 + (tempu2+tempg21/10) * fval2 + tempu3 * fval3
  Ymean2[,i] <- ifelse( zi==1, 1, -1 ) * 4 + ifelse( zi==3, 1, 0 ) * 5*te + tempg11/10 + (tempu6+tempg32/10) * fval6 + (tempu5+tempg31/10) * fval5 
  Ymean3[,i] <- zi * (2*te+1.5) +tempu8 * fval8 + tempu9 * fval9
}
