...
// [[Rcpp::export]]
mat getTHETA0( vec nts, mat nobs, mat B, vec Sigmas, int tempK, double psi, mat LFLM, mat Eta, mat Ydat ){   //////
...
// [[Rcpp::export]]
mat getTHETA( int cc, vec kkind, vec nts, mat nobs, mat B, vec Sigmas, vec KKs, vec psi, mat LFLM, mat Eta, mat Ydat ){  //////
...
// [[Rcpp::export]]
vec getpsi( vec nts, double a_psi, double b_psi, int cc, mat nobs, vec KKs, mat THETAcs, mat Ydat, mat B ){
...
// [[Rcpp::export]]
double getpsi0( vec nts, double a_psi, double b_psi, mat nobs, mat THETA, mat Ydat, mat B ){
...
// [[Rcpp::export]]
mat getPSIis( vec nts, vec Sigmas, int tempK, int H, mat LFLM, mat Eta, mat hatPSIis, mat Svaris ){   //////
