...
# title(main="(h) 2012, n=24")
# 
# plot(msc1[,17], type='l', ylim=c(8,37), main=expression("(a) O"[3]*", 1987-2012"), ylab=expression("O"[3]*" (ppb)"), xlab='Month', xaxt='n')
# axis(1, monthnum, monthnames, labels = F)
# text(monthnum, par("usr")[3] - 1, labels = monthnames, srt = 45, pos = 1, xpd = TRUE, cex=0.85)
# for(i in sort(unique(clusters2))){ lines(msc1[,clusters[which(clusters2 == i)[1]]], col=i, lwd=3) }
...
# 
# plot(msc2[,17], type='l', ylim=c(5,25), main=expression("(b) NO"[2]*", 1987-2012"), ylab=expression("NO"[2]*" (ppb)"), xlab='Month', xaxt='n')
# axis(1, monthnum, monthnames, labels = F)
# text(monthnum, par("usr")[3] - 1, labels = monthnames, srt = 45, pos = 1, xpd = TRUE, cex=0.85)
# for(i in sort(unique(clusters2))){ lines(msc2[,clusters[which(clusters2 == i)[1]]], col=i, lwd=3) }
# 
...
plot(msc1[,7], type='l', ylim=c(8,37), main=expression("(a) O"[3]*", 1987-2012"), ylab=expression("O"[3]*" (ppb)"), xlab='Month', xaxt='n')
axis(1, monthnum, monthnames, labels = F)
text(monthnum, par("usr")[3] - 1, labels = monthnames, srt = 45, pos = 1, xpd = TRUE, cex=0.85)
for(i in sort(unique(clusters2))){ lines(msc1[,clusters[which(clusters2 == i)[1]]], col=i, lwd=3) }
legend("topright", legend = c("cluster 1", "cluster 2", "cluster 3", "cluster 4", "cluster 5", "cluster 6"), 
       col=c(1,2,4,3,5,6), lwd=c(1.5,1.5,1.5,1.5,1.5,1.5), cex=0.9)
...
segments( ((mcc.indicators[citynum_mcc,geo_list[2]]))[22], ((mcc.indicators[citynum_mcc,geo_list[1]]))[22], 
          ((mcc.indicators[citynum_mcc,geo_list[2]]))[22]+5, ((mcc.indicators[citynum_mcc,geo_list[1]]))[22]-1,col=1  )
text( ((mcc.indicators[citynum_mcc,geo_list[2]]))[22]+10, ((mcc.indicators[citynum_mcc,geo_list[1]]))[22]-1.2, mcc_cityname[20], cex=1, col=1  )
text( ((mcc.indicators[citynum_mcc,geo_list[2]]))[2], ((mcc.indicators[citynum_mcc,geo_list[1]]))[2]-1.3, mcc_cityname[2], cex=1, col=1  )
...
segments( ((mcc.indicators[citynum_mcc,geo_list[2]]))[22], ((mcc.indicators[citynum_mcc,geo_list[1]]))[22], 
          ((mcc.indicators[citynum_mcc,geo_list[2]]))[22]+5, ((mcc.indicators[citynum_mcc,geo_list[1]]))[22]-1,col=1  )
text( ((mcc.indicators[citynum_mcc,geo_list[2]]))[22]+10, ((mcc.indicators[citynum_mcc,geo_list[1]]))[22]-1.2, mcc_cityname[20], cex=1, col=1  )
text( ((mcc.indicators[citynum_mcc,geo_list[2]]))[2], ((mcc.indicators[citynum_mcc,geo_list[1]]))[2]-1.3, mcc_cityname[2], cex=1, col=2  )
...
segments( ((mcc.indicators[citynum_mcc,geo_list[2]]))[22], ((mcc.indicators[citynum_mcc,geo_list[1]]))[22], 
          ((mcc.indicators[citynum_mcc,geo_list[2]]))[22]+5, ((mcc.indicators[citynum_mcc,geo_list[1]]))[22]-1,col=4  )
text( ((mcc.indicators[citynum_mcc,geo_list[2]]))[22]+10, ((mcc.indicators[citynum_mcc,geo_list[1]]))[22]-1.2, mcc_cityname[20], cex=1, col=4  )
text( ((mcc.indicators[citynum_mcc,geo_list[2]]))[2], ((mcc.indicators[citynum_mcc,geo_list[1]]))[2]-1.3, mcc_cityname[2], cex=1, col=2  )
...
legend("topright", legend = c("cluster 1", "cluster 2", "cluster 3", "cluster 4", "cluster 5", "cluster 6"), 
       col=c(1,2,4,3,5,6), lwd=c(1.5,1.5,1.5,1.5,1.5,1.5), cex=0.8)
